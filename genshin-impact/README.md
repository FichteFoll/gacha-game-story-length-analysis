...
**Total for the whole main questline: <!--f:grand_total-->112 h 26 min<!--/f-->** (<!--f:n_report_entries-->45<!--/f--> entries counting acts, preludes and interludes, measured against <!--f:n_videos-->489<!--/f--> accepted uploads out of <!--f:n_candidates-->698<!--/f--> candidates).
